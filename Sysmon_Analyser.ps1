...
#>
    ...
    - DONE: List fields for specific logs e.g. -QueryID 1 -FieldList should produce Image, ParentImage, etc
    - DONE: Add Print with limit 
    - DONE: Next thing would be to search by a field inside an event ID and pull all the matching events out
